...
class DailyReviewGenerator:
    ...
    def __init__(self, date: str = None):
        ...
        # 数据源路径
        self.position_file = Path.home() / '.openclaw' / 'workspace' / 'projects' / 'AI-Trader' / 'data' / 'agent_data' / 'trade-agent' / 'position' / 'position.jsonl'
        self.log_dir = Path.home() / '.openclaw' / 'workspace' / 'projects' / 'AI-Trader' / 'data' / 'agent_data' / 'trade-agent' / 'log'
