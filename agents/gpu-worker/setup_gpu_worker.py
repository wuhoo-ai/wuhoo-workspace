...
def hermes_cli(args, hermes_home):
...
def main():
    ...
    if not os.path.isdir(PROFILE):
        r = hermes_cli(['profile', 'create', 'gpu-worker', '--clone'], HERMES_HOME)
    ...
    r = hermes_cli(['-p', 'gpu-worker', 'peer', 'add', 'cloud', '--url', 'http://47.79.255.24:28643', '--key', ckey], HERMES_HOME)
