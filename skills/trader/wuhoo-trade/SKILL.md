...
- `STOCK_PICK_SCRIPT` → `~/wuhoo-workspace/skills/trader/wuhoo-stock-pick/stock_pick.py`
- `FACTORS_DIR` → `~/wuhoo-workspace/data/stock-pick/factors/`
- `DEBATE_PATH` → `~/wuhoo-workspace/skills/trader/wuhoo-debate/`
...
| `STOCK_PICK_SCRIPT` | `~/wuhoo-workspace/skills/stock-pick/stock_pick.py` | `~/wuhoo-workspace/skills/trader/wuhoo-stock-pick/stock_pick.py` |
