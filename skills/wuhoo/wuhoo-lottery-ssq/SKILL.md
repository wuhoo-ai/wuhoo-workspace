...
metadata:
  hermes:
    emoji: "🎱"
    tags: ["wuhoo", lottery, prediction, statistics, analysis]
    requires:
      bins: [python3.11]
...
```bash
cd ~/wuhoo-workspace/skills/wuhoo-lottery-ssq
