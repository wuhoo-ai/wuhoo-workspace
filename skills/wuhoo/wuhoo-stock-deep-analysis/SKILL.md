...
# 港股
python3.11 ~/wuhoo-workspace/skills/wuhoo-stock-deep-analysis/deep_analysis.py --code 00700 --name 腾讯控股

# 美股（仅因子分析，无 akshare 财务数据）
python3.11 ~/wuhoo-workspace/skills/wuhoo-stock-deep-analysis/deep_analysis.py --code US.AAPL --name Apple
