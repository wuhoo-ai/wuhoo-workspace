...
def build_data_sources():
    ...
    # RSS feeds
    rss_dir = Path('/home/admin/wuhoo-workspace/skills/default/wuhoo-news-rss')
...
def generate_report(json_path, output_path=None):
    ...
    try:
        db = sqlite3.connect('/home/admin/wuhoo-workspace/skills/default/wuhoo-news-rss/data/news.db')
        for m in matches:
